...
# Création du pipeline du modèle avec XGBoost Regressor
...
emp_data.to_excel(r"C:\Users\lando\Desktop\analyse pi\predictions_satisfaction_employes_xgboost2.xlsx", index=False)
